package cn.mhonor.view.window.frame;

import cn.mhonor.beans.HttpMethod;
import cn.mhonor.beans.PropertiesKey;
import cn.mhonor.beans.Request;
import cn.mhonor.service.Notify;
import cn.mhonor.service.topic.RefreshServiceTreeTopic;
import cn.mhonor.service.topic.ServiceTreeTopic;
import cn.mhonor.utils.RestUtil;
import cn.mhonor.utils.SystemUtil;
import cn.mhonor.view.window.RestfulTreeCellRenderer;
...
public class RightToolWindow extends JSplitPane {
    ...
    private void initView(@NotNull JPanel headPanel) {
        ...
        scanApi.setContentAreaFilled(false);
        // 去掉按钮的边框
        ...
        scanApiFilter.setContentAreaFilled(false);
