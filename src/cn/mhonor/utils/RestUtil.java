package cn.mhonor.utils;

import cn.hutool.core.util.ReUtil;
import cn.mhonor.beans.PropertiesKey;
import cn.mhonor.beans.Request;
import cn.mhonor.utils.scanner.JarsHelper;
import cn.mhonor.utils.scanner.SpringHelper;
...
public class RestUtil {
    ...
    public static List<Request> getAllRequestByModule(@NotNull Project project, @NotNull Module module) {
        // JAX-RS方式
        List<Request> jaxrsRequestByModule = JarsHelper.getJarsRequestByModule(project, module);
